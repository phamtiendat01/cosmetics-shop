...
<?php $__env->startSection('title','Thanh toán | Cosme House'); ?>
        ...
        <div class="lg:col-span-8 space-y-6">
            ...
            <div class="bg-white border border-rose-100 rounded-2xl p-4">
                ...
                <div class="text-sm text-ink/60">
                    ...
                    <a class="text-brand-600 underline" href="<?php echo e(route('account.addresses.index')); ?>">Sổ địa chỉ</a>.
                </div>
                <?php else: ?>
                <div class="space-y-2" id="addrList">
                    ...
                    <label class="option addr-card"
                        data-name="<?php echo e($a->name); ?>"
                        data-phone="<?php echo e($a->phone); ?>"
                        data-line1="<?php echo e($line1); ?>"
                        data-line2="<?php echo e($line2); ?>"
                        data-ward="<?php echo e($ward); ?>"
                        data-district="<?php echo e($district); ?>"
                        data-city="<?php echo e($city); ?>">
                        <input type="radio" name="address_id" value="<?php echo e($a->id); ?>" <?php echo e(($selected?->id===$a->id)?'checked':''); ?>>
                        <div class="text-sm">
                            <div class="font-medium text-rose-700"><?php echo e($a->name); ?> • <?php echo e($a->phone); ?></div>
                            <div class="text-ink/70">
                                <?php echo e($line1); ?><?php echo e($line2 ? ', '.$line2 : ''); ?>,
                                <?php echo e($ward ? $ward.', ' : ''); ?><?php echo e($district); ?>, <?php echo e($city); ?>

                            </div>
                            <?php if($a->is_default_shipping): ?>
                ...
                <div class="mt-2 text-xs">
                    <a href="<?php echo e(route('account.addresses.index')); ?>" class="text-brand-600 underline">Quản lý sổ địa chỉ</a>
                </div>
                <?php endif; ?>
            </div>
            <?php endif; ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input id="name" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                            value="<?php echo e($profile['name'] ?? ''); ?>" placeholder="Nguyễn Văn A">
                    </div>
                    <div>
                        ...
                        <input id="phone" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                            value="<?php echo e($profile['phone'] ?? ''); ?>" placeholder="09xxxxxxxx">
                    </div>
                    <div class="md:col-span-2">
                        ...
                        <input id="email" type="email" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                            value="<?php echo e($profile['email'] ?? ''); ?>" placeholder="you@email.com">
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input id="address" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                            value="<?php echo e(trim(($selected?->line1 ?? $selected?->address ?? '').' '.($selected?->line2 ?? ''))); ?>"
                    ...
                    <div>
                        ...
                        <input id="ward" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                            value="<?php echo e($selWard); ?>" placeholder="Phường/Xã">
                    </div>
                    <div>
                        ...
                        <input id="district" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                            value="<?php echo e($selDistrict); ?>" placeholder="Quận/Huyện">
                    </div>
                    <div class="md:col-span-2 md:grid md:grid-cols-2 md:gap-3">
                        <div class="md:col-span-1">
                            ...
                            <input id="city" class="mt-1 w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-brand-300"
                                value="<?php echo e($selCity); ?>" placeholder="Tỉnh/Thành phố">
                        </div>
                        <div class="md:col-span-1">
            ...
            <div class="bg-white border border-rose-100 rounded-2xl p-4">
                ...
                <div class="space-y-2" id="payMethods">
                    ...
                    ?>
                    <?php $__currentLoopData = $methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=>$m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <label class="option">
                        <input type="radio" name="payment_method" value="<?php echo e($m['code']); ?>" <?php echo e($i===0?'checked':''); ?>>
                        <span class="pm-icon">
                            <?php switch($m['icon']):
                            case ('qr'): ?>
                        ...
                        <div class="min-w-0">
                            <div class="font-medium"><?php echo e($m['label']); ?></div>
                            <div class="text-sm text-ink/60"><?php echo e($m['hint']); ?></div>
                        </div>
                    </label>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="bg-white border border-rose-100 rounded-2xl p-4 space-y-4">
                ...
                <div class="divide-y">
                    ...
                    <div class="py-3 flex items-start justify-between gap-3">
                        <div class="flex items-start gap-3 min-w-0">
                            <?php if($img): ?>
                            <img class="item-thumb" src="<?php echo e($img); ?>" alt="">
                            <?php else: ?>
                            <div class="item-ph">SP</div>
                            <?php endif; ?>
                            <div class="min-w-0">
                                <div class="font-medium line-clamp-1"><?php echo e($it['name'] ?? ('SP #'.$it['product_id'])); ?></div>
                                <?php if(!empty($it['variant_name'])): ?>
                                <div class="text-xs text-ink/60 mt-0.5"><?php echo e($it['variant_name']); ?></div>
                                <?php endif; ?>
                                <div class="text-xs text-ink/60 mt-0.5">x<?php echo e((int)($it['qty']??1)); ?></div>
                            </div>
                        </div>
                        <div class="font-semibold whitespace-nowrap"><?php echo e(number_format($line,0,',','.')); ?>₫</div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
                ...
                <div class="bg-rose-50/40 border border-rose-100 rounded-2xl p-3">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-sm text-ink/60">
                            Số dư:
                            <b id="wlBal" data-bal="<?php echo e($walletBalance); ?>"><?php echo e(number_format($walletBalance)); ?>₫</b>
                        </div>
                    </div>

                    <div class="mt-2 flex items-center gap-2">
                        <label class="inline-flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" id="wlUse" class="accent-rose-600" <?php echo e($walletBalance>0 ? '' : 'disabled'); ?>>
                ...
                <div>
                    ...
                    <div id="shipWrap" class="relative">
                        <div id="shipRow" class="flex gap-2 <?php echo e($shipCode ? 'hidden' : ''); ?>">
                            <input id="shipInput"
                        ...
                        <div id="shipApplied" class="<?php echo e($shipCode ? 'flex' : 'hidden'); ?> mt-2 items-center gap-2">
                            <span class="px-2 py-1 bg-emerald-50 text-emerald-700 rounded text-sm">
                                Đã áp dụng: <span id="shipCode"><?php echo e($shipCode); ?></span>
                            </span>
                ...
                <div class="space-y-1 text-sm">
                    <div class="flex justify-between">
                        <span>Tạm tính</span>
                        <span id="ckSubtotal" data-val="<?php echo e($subtotal); ?>"><?php echo e(number_format($subtotal,0,',','.')); ?>₫</span>
                    </div>

                    <div class="flex justify-between">
                        <span>Phí vận chuyển</span>
                        <span id="ckShipFee" data-val="<?php echo e($shipping); ?>">
                            <?php echo e($shipping>0? number_format($shipping,0,',','.') .'₫' : 'Miễn phí'); ?>
                    ...
                    <div class="flex justify-between text-emerald-700">
                        ...
                        <span id="ckShipDiscount" data-val="<?php echo e($shipDiscount); ?>"><?php echo e(number_format($shipDiscount,0,',','.')); ?>₫</span>
                    </div>

                    
                    <div class="flex justify-between">
                        <span>Tổng (trước khi trừ ví)</span>
                        <span id="ckGrand" data-val="<?php echo e($grand); ?>"><?php echo e(number_format($grand,0,',','.')); ?>₫</span>
                    </div>
                    ...
                    <div class="border-t border-rose-100 pt-2 text-base font-semibold flex justify-between">
                        ...
                        <span id="ckPayable" data-val="<?php echo e($grand); ?>"><?php echo e(number_format($grand,0,',','.')); ?>₫</span>
                    </div>
                </div>
...
<script>
    const R = {
        place: <?php echo json_encode(route('checkout.place'), 15, 512) ?>,
        quote: <?php echo json_encode(route('shipping.quote'), 15, 512) ?>,
        ordersIndex: <?php echo json_encode(route('account.orders.index'), 15, 512) ?>,
        /* APIs riêng cho MÃ VẬN CHUYỂN */
        shipMine: <?php echo json_encode(route('ship.mine'), 15, 512) ?>, // GET
        shipApply: <?php echo json_encode(route('ship.apply'), 15, 512) ?>, // POST {code, address_id?}
        shipRemove: <?php echo json_encode(route('ship.remove'), 15, 512) ?>, // DELETE
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cosmetics-shop\resources\views/checkout/index.blade.php ENDPATH**/ ?>