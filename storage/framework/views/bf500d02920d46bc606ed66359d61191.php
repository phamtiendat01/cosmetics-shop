...
<head>
    ...
    <title>In QR Codes - Đơn hàng <?php echo e($order->code); ?></title>
    <?php
...
<body>
    ...
    <div class="preview-container no-print">
        <div class="preview-header">
            ...
            <p>Đơn hàng: <strong><?php echo e($order->code); ?></strong></p>
        </div>
        ...
        <div class="preview-info">
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value"><?php echo e($order->placed_at ? $order->placed_at->format('d/m/Y H:i') : 'N/A'); ?></span>
                </div>
                <div class="info-item">
                    <span class="info-label">Tổng số QR codes</span>
                    <span class="info-value"><?php echo e($qrCodes->count()); ?> tem</span>
                </div>
            </div>
        </div>

        <?php if($qrCodes->isEmpty()): ?>
        ...
        <div class="preview-qr-grid">
            ...
            <div class="preview-qr-item">
                ...
                <img src="<?php echo e(Storage::disk('public')->url($qr->qr_image_path)); ?>" alt="QR Code">
                <?php elseif($qr->qr_image_url): ?>
                <img src="<?php echo e($qr->qr_image_url); ?>" alt="QR Code">
                <?php else: ?>
                ...
                <div class="product-name">
                    <?php echo e($qr->productVariant->product->name ?? 'N/A'); ?>

                </div>
                <div class="qr-code-text">
                    <?php echo e($qr->qr_code); ?>
...
<?php /**PATH C:\xampp\htdocs\cosmetics-shop\resources\views/admin/orders/print-qr-codes.blade.php ENDPATH**/ ?>