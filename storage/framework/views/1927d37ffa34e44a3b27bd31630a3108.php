...
<?php $__env->startSection('title','Hộp quà bí ẩn'); ?>
...
<div class="mystery-stage">
    <div class="mystery-wrap">
        ...
        <div class="mystery-grid">
            <?php for($i=1;$i<=9;$i++): ?>
                <button class="mystery-cell" data-box="<?php echo e($i); ?>" onclick="mysteryOpen(<?php echo e($i); ?>)" disabled>
                <!-- SVG GIFT – contrast cao, nét, có halo -->
                <svg id="gift-<?php echo e($i); ?>" class="mystery-gift" width="160" height="160" viewBox="0 0 200 200" fill="none">
                    <defs>
...
<script>
    ...
    const API = {
        config: `<?php echo e(route('mystery.config')); ?>`,
        play: `<?php echo e(route('mystery.play')); ?>`
    };
    let remain = 0,
        busy = false,
        lastLogId = null;
    ...
    <div class="mystery-actions">
      ...
      <a href="<?php echo e(route('cart.index')); ?>" class="mbtn mbtn-blue" style="text-decoration:none">Dùng ngay</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cosmetics-shop\resources\views/game/mystery.blade.php ENDPATH**/ ?>