...
<div class="flex items-center gap-2 flex-wrap">
    ...
    ?>
    <a href="<?php echo e($url); ?>" class="inline-flex items-center gap-2 px-2.5 py-1.5 rounded-full border border-rose-200 text-sm">
        <?php echo e($chip['label']); ?> <i class="fa-regular fa-xmark text-ink/50"></i>
    </a>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <a href="<?php echo e(url()->current()); ?>" class="text-sm text-rose-600 hover:underline">Xoá tất cả</a>
</div>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\cosmetics-shop\resources\views/category/partials/selected-chips.blade.php ENDPATH**/ ?>