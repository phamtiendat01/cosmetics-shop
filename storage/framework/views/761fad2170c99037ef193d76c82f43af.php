...
<div class="max-w-6xl mx-auto px-4 py-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="gcard shadow-sm hover:shadow-xl transition">
            <?php if($times>1): ?>
            <div class="badge-x" title="Số lần lưu">×<?php echo e($times); ?></div>
            <?php endif; ?>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="min-w-0 flex-1">
                        <div class="flex items-center gap-2 flex-wrap">
                            <span class="text-lg font-extrabold tracking-tight"><?php echo e($it->code); ?></span>
                            <?php if($statusOk): ?>
                        ...
                        <div class="text-sm text-gray-700 mt-1">
                            <span class="font-semibold"><?php echo e($isPercent ? 'Giảm' : 'Trừ'); ?> <?php echo e($valueStr); ?> phí ship</span>
                        ...
                        <div class="flex flex-wrap gap-2 mt-2">
                            <?php if($carriers->count()): ?>
                            <span class="chip">Hãng: <?php echo e($carriers->take(2)->implode(', ')); ?><?php if($carriers->count()>2): ?> +<?php echo e($carriers->count()-2); ?><?php endif; ?></span>
                            <?php endif; ?>
                            <?php if($regions->count()): ?>
                            <span class="chip">Khu vực: <?php echo e($regions->take(2)->implode(', ')); ?><?php if($regions->count()>2): ?> +<?php echo e($regions->count()-2); ?><?php endif; ?></span>
                            <?php endif; ?>
                        </div>

                        
                        <div class="mt-2 text-xs text-gray-500">
                            Đã dùng: <b><?php echo e($used); ?></b> / <?php echo e($times); ?> <?php if($left>0): ?> • <span class="text-emerald-600 font-semibold">Còn lại: <?php echo e($left); ?></span><?php endif; ?>
                        </div>

                        
                        <div class="text-xs text-gray-400 mt-1">
                            <?php if($start): ?> Bắt đầu: <?php echo e($start->format('d/m/Y H:i')); ?> <?php endif; ?>
                            <?php if($end): ?> • Hết hạn: <?php echo e($end->format('d/m/Y H:i')); ?> <?php endif; ?>
                        </div>

                        
                        <div class="mt-3 flex gap-2">
                            <button class="px-3 py-2 rounded-lg bg-gray-100 hover:bg-gray-200 text-sm"
                                onclick="navigator.clipboard.writeText('<?php echo e($it->code); ?>'); miniToast('Đã copy mã');">
                                Copy mã
                            </button>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.empty','data' => ['text' => 'Bạn chưa lưu mã vận chuyển nào.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['text' => 'Bạn chưa lưu mã vận chuyển nào.']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cosmetics-shop\resources\views/account/ship-vouchers.blade.php ENDPATH**/ ?>