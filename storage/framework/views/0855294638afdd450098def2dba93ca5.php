...
<?php $__env->startSection('title', 'Thanh toán VietQR'); ?>
...
<div class="container mx-auto max-w-6xl px-4 py-6">
    ...
    <div id="vietqr-root"
        ...
        data-deadline-ts="<?php echo e($deadlineTs ?? ''); ?>"
        data-check-url="<?php echo e($checkUrl); ?>"
        data-redirect-url="<?php echo e($redirectUrl); ?>"
        data-ttl-min="<?php echo e($ttlMin ?? 15); ?>"></div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl border shadow-sm p-4 shine">
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm text-slate-500"><?php echo e($bank ?? 'Ngân hàng'); ?></div>
            </div>
            ...
            <div class="relative mt-4 w-full max-w-md mx-auto">
                ...
                <img src="<?php echo e($qr_url); ?>" alt="Mã VietQR"
            ...
            <div class="mt-4 flex flex-wrap gap-2">
                <button id="copyAcc" class="ripple inline-flex items-center gap-2 px-3 py-2 rounded-lg border bg-slate-50 hover:bg-slate-100 text-sm"
                    data-copy="<?php echo e($account); ?>">
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <rect x="9" y="9" width="13" height="13" rx="2" />
                        <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
                    </svg>
                    Sao chép STK: <b><?php echo e($account); ?></b>
                </button>
                ...
                <button id="copyRef" class="ripple inline-flex items-center gap-2 px-3 py-2 rounded-lg border bg-slate-50 hover:bg-slate-100 text-sm"
                    data-copy="<?php echo e($ref); ?>">
                    <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                        <path d="M21 15v4a2 2 0 0 1-2 2h-7" />
                        <path d="M3 9V5a2 2 0 0 1 2-2h7" />
                        <rect x="7" y="7" width="10" height="10" rx="2" />
                    </svg>
                    Sao chép nội dung: <b><?php echo e($ref); ?></b>
                </button>

                <a href="<?php echo e($qr_url); ?>" download="vietqr-<?php echo e($order->id); ?>.jpg"
        ...
        <div class="space-y-4">
            <div class="bg-white rounded-2xl border shadow-sm p-4">
                ...
                <div class="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div class="rounded-xl border p-3 bg-slate-50">
                        ...
                        <div class="font-semibold"><?php echo e($account); ?></div>
                    </div>
                    <div class="rounded-xl border p-3 bg-slate-50">
                        <div class="text-xs text-slate-500">Tên người nhận</div>
                        <div class="font-medium"><?php echo e(config('vietqr.name')); ?></div>
                    </div>
                    <div class="rounded-xl border p-3 bg-slate-50">
                        <div class="text-xs text-slate-500">Nội dung</div>
                        <div class="font-medium"><?php echo e($ref); ?></div>
                    </div>
                    <div class="rounded-xl border p-3 bg-slate-50">
                        <div class="text-xs text-slate-500">Số tiền</div>
                        <div class="font-semibold"><?php echo e(number_format($amount)); ?> đ</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border shadow-sm p-4">
                ...
                <ol class="mt-3 list-decimal list-inside space-y-1 text-sm">
                    ...
                    <li>Kiểm tra <b>số tiền</b> và <b>nội dung</b> đúng <b><?php echo e($ref); ?></b>.</li>
                ...
                <details class="mt-3">
                    ...
                    <ul class="mt-2 text-sm text-slate-600 list-disc list-inside">
                        ...
                        <li>Luôn ghi đúng nội dung <b><?php echo e($ref); ?></b> để hệ thống khớp lệnh.</li>
                    </ul>
                </details>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cosmetics-shop\resources\views/payments/vietqr.blade.php ENDPATH**/ ?>